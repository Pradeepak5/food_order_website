<?php 
    include('private-front/menu.php');
?>
<?php
        ...
        <div class="container">
            ...
            <form action=""  method="POST" class="order">
                <fieldset>
                    ...
                    <?php
                        ...
                        {
                            ?>
                            <img src="<?php echo HOMEURL; ?>images/food/<?php echo $image_name; ?>" alt="food item" class="img-responsive img-curve">
                            <?php
                ...
                <fieldset>
                    ...
                    <input type="tel" name="contact" placeholder=" P.NO" class="input-responsive" required>
            ...
            <?php
                if(isset($_POST['submit']))
                {
                    ...
                    if($res2==true)
                    {
                        $_SESSION['order']="<div class='msg text-center'> Food Ordered Successfully.</div>";
                        header('location:'.HOMEURL);
